package cute.ztt.location.demo;
...
import cute.ztt.R;
import cute.ztt.location.service.LocationService;
...
public class IsHotWifiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locService = ((cute.ztt.location.demo.LocationApplication) getApplication()).locationService;
